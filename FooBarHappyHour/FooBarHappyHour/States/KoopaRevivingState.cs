...
{
    public class KoopaRevivingState : IKoopaState
    {
        ...
        public KoopaRevivingState(Koopa koopa)
        {
            ...
            sprite = EnemySpriteFactory.Instance.CreateKoopaRevivingSprite();
            Width = sprite.Width;
        ...
        {
            // Do nothing, koopa in reviving state does not move
        }
        ...
        public void Revive()
        {
            koopa.State = new KoopaWalkingState(koopa);
        }
